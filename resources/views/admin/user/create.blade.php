            ...
            <div class="card-body">
                <form action="{{route('admin.user.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group pb-3 col-md-6">
                        ...
                        <input type="email" class="form-control mb-0" id="email-id" placeholder="Masukan Email" name="email" required>
                    </div>
                    <div class="form-group pb-3 col-md-6">
                        <label class="form-label" for="email-id">Password</label>
                        <input type="password" class="form-control mb-0" id="email-id" placeholder="Masukan Password" name="password" required>
                    </div>
