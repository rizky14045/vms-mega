        ...
        <div class="card">
            <div class="d-flex justify-content-between align-items-center px-3 pt-3">
                <div class="search-from">
                    <form action="{{route('security.user-register.index')}}" method="GET">
                ...
                {{-- <a href="{{ route('security.user-register.create') }}" class="btn btn-success">Tambah Data</a> --}}
            </div>         
            <div class="card-body">
                @if(session('error'))
                    ...
                    <table class="table table-bordered table-striped mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="{{route('security.user-register.detail',['id'=>$register->id])}}" class="btn btn-warning btn-sm">Detail</a>
                                </td>
                            </tr>
                            @endforeach
