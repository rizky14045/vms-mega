...
class UserRegisterController extends Controller
{
    public function index(Request $request){
        ...
        return view('supervisor.user-register.index',$data);
    }

    public function approve($id){
        
        $register = RegisterUser::where('id',$id)->first();
        $rangking = $register->category == 'urgent' ? 3 : 2;
    ...
    public function create(){
        ...
        return view('supervisor.user-register.create',$data);
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            if($checkRegister){
                ...
                return redirect()->route('supervisor.user-register.index');
            }
            ...
            if(!empty($block)){
                return redirect()->route('supervisor.user-register.index')->with('error',$block);
            }
    ...
    public function detail($id){
        ...
        return view('supervisor.user-register.detail',$data);
    }

    public function edit(){
        return view('supervisor.user-register.edit');
    }

    public function reschedule($id){
        $data['schedule'] = RegisterUser::where('id', $id)->first();
        return view('supervisor.user-register.reschedule',$data);
    }
